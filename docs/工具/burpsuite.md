...
- python写插件时。当需要调用的外部类包含遇到pyd文件就无法进行下去了，因为pyd是C写的，Jython是无法使用C写的模块的。burp本身是Java写的，使用Java去开发插件兼容性最高，会少很多莫名其妙的错误。
...
![image-20220917114028960](burpsuite.assets/image-20220917114028960.png)
